 ...
 */
final class AttributeEnvironmentPayloadNoiseTransition extends AttributeEnvironmentPayload{
	...
	public function __construct(
		...
		private AttributeNoiseTransitionSettings $settings,
	){}
	...
	public function getSettings() : AttributeNoiseTransitionSettings{ return $this->settings; }

	public static function read(ByteBufferReader $in) : self{
		$fromAttribute = AttributeValue::read($in);
		$toAttribute = AttributeValue::read($in);
		$settings = AttributeNoiseTransitionSettings::read($in);
